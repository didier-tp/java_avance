...
public class MyNumberConcurrentSynchronizedList implements Runnable{
    ...
    public MyNumberConcurrentSynchronizedList(ThreadRole threadRole, List<Integer> numbers){
    ...
    public static void main(String[] args) {
        System.out.println("MyNumberConcurrentSynchronizedList");
        List<Integer> commonNumbers = new ArrayList<>();
        Thread addRandomThread = new Thread(new MyNumberConcurrentSynchronizedList(ThreadRole.ADD_RANDOM , commonNumbers));
        Thread retreiveEvenThread = new Thread(new MyNumberConcurrentSynchronizedList(ThreadRole.RETREIVE_EVEN, commonNumbers));
        Thread retreiveOddThread = new Thread(new MyNumberConcurrentSynchronizedList(ThreadRole.RETREIVE_ODD, commonNumbers));
