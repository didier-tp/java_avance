package tp.market.my_v2;

import tp.market.model.Stock;
import tp.market.my_v2.my_task.MyOrderCollectorTaskJmsV2;
import tp.market.my_v2.my_task.MyOrderCollectorTaskRmiV2;
import tp.market.my_v2.my_task.MyOrderCollectorTaskSocketV2;
...
public class MyBasicMarketServerAppV2 {
    public static void main(String[] args) {
        System.out.println("MyBasicMarketServerAppV2");
        initDataSet();

        //au moins 1 thread de type "collect_order"

        Thread orderCollectorThread2a = new Thread(new MyOrderCollectorTaskSocketV2(String.valueOf(1)));
        orderCollectorThread2a.start();

        Thread orderCollectorThread2b = new Thread(new MyOrderCollectorTaskRmiV2(String.valueOf(2)));
        orderCollectorThread2b.start();

        Thread orderCollectorThread2c = new Thread(new MyOrderCollectorTaskJmsV2(String.valueOf(3)));
